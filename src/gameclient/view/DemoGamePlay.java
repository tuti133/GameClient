...
import gameclient.controller.QuestionController;
 ...
 * @author Nobody
 */
public class DemoGamePlay extends javax.swing.JFrame {
    ...
    public DemoGamePlay() {
        initComponents();
        listQuestions = getRandomQuestions(Constant.RANDOM_QUESTION_NUMBER);
    ...
    private List<Question> getRandomQuestions(int number) {
        try {
            GetRandomQuestionResponseDto response = questionController.getRandomQuestions(number);
            if (response == null) {
                showMessage("Lỗi");
                return null;
            }
            ...
            Logger.getLogger(DemoGamePlay.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        showMessage("Ban tra loi dung " + correctAnswer + " cau.");
...
//        new GameOverFrm().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DemoGamePlay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DemoGamePlay().setVisible(true);
            }
        });
    }
